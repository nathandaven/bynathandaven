...
I'm Nathan Davenport, a professional **software engineer**, and self proclaimed **video-journalist** and **photographer** in **Atlanta, Georgia**.
...
I just find **urban studies** really interesting, which is why I made a [YouTube channel](https://youtube.com/@nathandaven) where I deep dive into **local urbanism**, including **land use**, **transportation**, **real-estate**, and more. I've also begun branching out, and covering some other topics outside of urbanism, and I'm excited to see where the channel goes next!
