...
<Divider className={"pt-5"} title="Collaborations" large={true} />
...
<Divider className={"pt-5"} title="Services" large={true} />
...
<Divider className={"pt-5"} title="Previous Projects" large={true} />
