...
export const Footer: FunctionComponent<PropsWithChildren> = ({ children, className, mobile = false }) => {
  return (
    <footer
    ...
    >
      <div className="justify-start text-left">
        <ul className="align-left leading-1 flex w-full max-w-[35rem] flex-col flex-wrap justify-start gap-x-2 pr-10 text-start sm:flex-row dark:text-gray-300">
          <li className="hover:text-dark-primary dark:hover:text-light-primary text-gray-700 transition-colors duration-75 dark:text-gray-300">
          ...
          <li className="hover:text-dark-primary dark:hover:text-light-primary hidden cursor-default text-gray-700 transition-colors duration-75 sm:block dark:text-gray-300">
            -
          </li>
          <li className="hover:text-dark-primary dark:hover:text-light-primary pt-2 text-gray-700 transition-colors duration-75 sm:pt-0 dark:text-gray-300">
