...
const Bluesky: FunctionComponent<PropsWithChildren> = ({ children, className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={classNames("", className)} viewBox="0 0 24 24">
    <title>BlueSky</title>
